...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="contribution_management.php">
          ...
          <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title mb-0">Manage Contribution</h5>
                </div>
                <form class="row g-3" method="POST" action="">
                  <div class="col-md-12">
                    <div class="form-floating">
                      <select class="form-select" id="floatingAddress" name="address" required onchange="loadMembers()">
                  ...
                  <div class="col-md-12">
                    <div class="form-floating">
                      <select class="form-select" id="floatingMember" name="complete_name" required>
                          <option value="">Select Member</option>
                        </select>
                        <label for="floatingMember">Member</label>
                    </div>
                  </div>
  ...
  <script>
    function loadMembers() {
        ...
        // Make an AJAX request to fetch members based on the selected address
        var xhr = new XMLHttpRequest();
        xhr.open("POST", "fetch_members.php", true);
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                document.getElementById("floatingMember").innerHTML = xhr.responseText;
            }
        };
